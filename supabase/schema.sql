...
DROP TABLE IF EXISTS major_careers, field_majors, careers, majors, fields, gemini_cache, assessment_results, riasec_translations, student_grades, profiles CASCADE;
...
CREATE POLICY "gemini_cache_service_only" ON gemini_cache
  FOR ALL USING (true);
